...
import CallActorSource from '!!raw-loader!./call_actor.js';
...
Go to the [Account - Integrations](https://console.apify.com/account#/integrations) page to obtain your API token
