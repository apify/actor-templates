...
import CrawlSource from '!!raw-loader!./puppeteer_with_proxy.js';
...
Visit the [Apify platform introduction](/docs/guides/apify-platform) to find how to log into your account from the SDK.
